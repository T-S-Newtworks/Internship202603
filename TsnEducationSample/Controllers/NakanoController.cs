...
using TsnEducationSample.Models;

namespace TsnEducationSample.Controllers
{
    public class NakanoController : Controller
    {
        /// <summary>
        /// TODOリスト画面表示処理
        /// </summary>
        ...
        public ActionResult SaveTodoItems(List<TodoItem> todoItems)
        {
            ...
            else
            {
                ...
                using (var overWriteFile = new StreamWriter(filePath, false, Encoding.GetEncoding("shift-jis")))
                {
                    ...
                    {
                        sb.AppendLine($"{item.Title},{item.Description},{item.day}");
                    }
